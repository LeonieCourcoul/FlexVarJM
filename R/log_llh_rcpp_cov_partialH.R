...
log_llh_rcpp_cov_partialH <- function(param, elementsMatCov_cov,nb.e.a, nb.priorMean.beta, nb.alpha, competing_risk,
  ...
  MatCovElements <- elementsMatCov_cov
  curseur <- 1
  ## Matrice de variance-covariance de l'ensemble des effets aléatoires :
  if(variability_hetero){
    if(correlated_re){
